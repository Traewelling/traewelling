...
class PointsCalculationTest extends UnitTestCase
{
    ...
    public function test_factor(PointReason $reason, float $expectedFactor): void
    {
    ...
    public function test_calculate_train_points(int $expectedPoints, HafasTravelType $hafasTravelType, Carbon $departure, Carbon $arrival, TripSource $tripSource): void
    {
