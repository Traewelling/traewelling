...
class RemoveAbsentWebhooksListenerTest extends FeatureTestCase
{
    ...
    public function test_it_removes_absent_webhook()
    {
        // GIVEN
    ...
    public function test_it_doesnt_interact_when_other_return_code()
    {
        // GIVEN
        $alice = User::factory()->create();
        $client = $this->createWebhookClient($alice);
    ...
    public function test_it_doesnt_interact_when_connect_exception()
    {
        // GIVEN
        $alice = User::factory()->create();
        $client = $this->createWebhookClient($alice);
    ...
    public function test_it_throws_when_webhook_to_delete_cannot_be_found()
    {
        // GIVEN
        $alice = User::factory()->create();
