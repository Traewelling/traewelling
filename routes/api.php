    ...
    Route::group(['middleware' => ['auth:api', 'privacy-policy']], static function () {
        ...
        Route::group(['prefix' => 'settings'], static function () {
            Route::put('acceptPrivacy', [PrivacyPolicyController::class, 'acceptPrivacyPolicy'])
                ->withoutMiddleware('privacy-policy'); // TODO: Remove after 2026-09-30
        ...
        Route::put('stations/{id}/usages/move', [StationController::class, 'moveUsages'])->whereNumber('id'); // admin only
    ...
    Route::group(['middleware' => ['privacy-policy']], static function () {
        Route::group(['middleware' => ['semiscope:read-statuses']], static function () {
            ...
            Route::post('trips/{tripUuid}/stopovers', [TripStopoverController::class, 'store'])
                ->whereUuid('tripUuid')->middleware('scope:write-statuses');
            Route::post('trips/{tripUuid}/stopovers/shift', [TripStopoverController::class, 'shift'])
                ->whereUuid('tripUuid')->middleware('scope:write-statuses');
