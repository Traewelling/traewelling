                ...
                <div class="card" id="leaderboard">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="main-tab" data-bs-toggle="tab" href="#leaderboard-main"
                                   role="tab" aria-controls="home" aria-selected="true">
                                    {{ __('leaderboard.top') }} {{$users->count()}}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="distance-tab" data-bs-toggle="tab" href="#leaderboard-distance"
