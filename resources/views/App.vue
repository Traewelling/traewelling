  ...
  metaInfo() {
    return {
      ...
      meta: [
        ...
        {name: "description", content: this.i18n.get("_.about.block1")},
        {name: "keywords", content: "Träwelling, Twitter, Deutsche, Bahn, Travel, Check-In, Zug, Bus, Tram, Mastodon"},
        {name: "audience", conent: "Travellers"},
        {name: "DC.Rights", content: "Träwelling Team"},
        {name: "DC.Description", content: this.i18n.get('_.about.block1')},
        {name: "DC.Language", content: this.i18n.getLocale()},
        {property: "og:title", content: "Träwelling"}, //ToDo get name from .env
