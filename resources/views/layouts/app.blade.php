    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="notifications-list">
                <div id="notifications-empty" class="text-center text-muted">{{ __('notifications.empty') }}<br/>¯\_(ツ)_/¯
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="navbar-toggler">
                <button class="navbar-toggler notifications-board-toggle" type="button" data-toggle="modal"
                        data-target="#notifications-board" aria-controls="navbarSupportedContent" aria-expanded="false"
                    ...
                    @else
                        <form class="form-inline" action="{{ route('userSearch') }}">
                            <div class="input-group md-form form-sm form-2 pl-0 m-0">
                                <input name="searchQuery"
                                       class="border border-white rounded-left form-control my-0 py-1" type="text"
                                       placeholder="Search" aria-label="User suchen">
                                <div class="input-group-append">
                                    <button class="input-group-text btn-primary lighten-2" id="basic-text1"
                                            type="submit"><i class="fas fa-search text-grey"
                        ...
                        <li class="nav-item d-none d-md-inline-block">
                            <a href="javascript:void(0)" id="notifications-toggle"
                               class="nav-link notifications-board-toggle" data-toggle="modal"
...
<div class="alert text-center cookiealert" role="alert">
    <b>Do you like cookies?</b> &#x1F36A; {{ __('messages.cookie-notice') }} <a
            href="{{route('static.privacy')}}">{{ __('messages.cookie-notice-learn') }}</a>
