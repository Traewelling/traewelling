<form action="{{ route('register') }}" method="POST" class="flex flex-col gap-4">
    ...
    <fieldset class="fieldset">
        ...
        <input type="text" class="input validator w-full @error('name') input-error @enderror" id="name" name="name" required
               autocomplete="name"/>
        @error('name')
        <p class="validator-hint text-error visible">
            {{ $message }}
    ...
    <fieldset class="fieldset">
        ...
        <input type="text" class="input validator w-full @error('email') input-error @enderror" id="email" name="email" required
    ...
    <fieldset class="fieldset">
        ...
        <input type="password" class="input validator w-full @error('password') input-error @enderror" id="password" name="password" required
