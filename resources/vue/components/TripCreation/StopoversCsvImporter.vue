...
export default {
  ...
  methods: {
    ...
    closeOffcanvas() {
      ...
      const instance = bs?.Offcanvas?.getOrCreateInstance
  ...
  >
    ...
    <div class="offcanvas-body">
      ...
      <ul class="small text-muted mb-3 ps-3">
        ...
        <li class="text-danger">{{ trans("trip_creation.csv_import.help.overwrites_all") }}</li>
      </ul>

      <div class="mb-2">
        <textarea class="form-control" rows="10" v-model.trim="csvText"></textarea>
      </div>
      ...
      <div class="small text-muted mb-3">
        ...
        <pre class="bg-light p-2 rounded border mb-2" style="white-space: pre-wrap;">12345,1970-01-01 08:05,1970-01-01 08:10
