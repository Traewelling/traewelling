    ...
    <LayoutBasic>
        <div>
            <div class="px-4 py-5 mt-n4"
                ...
                <div id="event-header" class="container">
              ...
              <span class="font-weight-bold">
                <i aria-hidden="true" class="fa fa-route d-inline"/>&nbsp;{{ event.trainDistance.toFixed(0) }}
              </span>
                ...
                <i aria-hidden="true" class="fa fa-link"/>&nbsp;<a :href="event.url"
                            ...
                            <h2>
                                ...
                                <span class="font-weight-bold"><a class="text-white" href="asdf">{{
                                        event.station.name
                                    }}</a></span>
                            </h2>
                        </div>
