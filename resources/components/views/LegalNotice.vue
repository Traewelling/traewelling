    ...
    <LayoutBasicNoSidebar>
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <h2>Kontakt</h2>
                <p v-if="this.mail">E-Mail: {{ this.mail }}</p>
                <p v-if="this.tel">Tel.: {{ this.tel }}</p>
                ...
                <h3>Thanks</h3>
                <p>This page uses Nunito Regular – Copyright 2014 The Nunito Project Authors
                    (contact@sansoxygen.com)</p>

                <p>This page uses data from OpenStreetMap, a free project with the aim of collecting freely utilisable
...
export default {
    ...
    data() {
        return {
            name: process.env.MIX_LEGAL_ADDRESS2,
            address1: process.env.MIX_LEGAL_ADDRESS1,
            address2: process.env.MIX_LEGAL_ADDRESS2,
            tel: process.env.MIX_LEGAL_TEL,
            mail: process.env.MIX_LEGAL_EMAIL
        };
    }
};
</script>
