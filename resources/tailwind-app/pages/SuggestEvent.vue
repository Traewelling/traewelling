            ...
            <div class="card-body">
                <form @submit.prevent="submit">
                    ...
                    <fieldset class="fieldset mb-4">
                        <legend class="fieldset-legend">{{ trans('contribute.suggest_event.field_name') }} *</legend>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <fieldset class="fieldset">
                            <legend class="fieldset-legend">{{ trans('contribute.suggest_event.field_end') }} *</legend>
                    ...
                    <fieldset class="fieldset mb-4">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="fieldset-legend">{{ trans('contribute.suggest_event.field_hashtag') }}</span>
                        </label>
                        ...
                        <div ref="stationDropdownRef" class="relative">
                            ...
                            <div v-if="selectedStation" class="flex items-center gap-2 mb-1">
                                <div class="badge badge-lg badge-primary gap-2">
                                    ...
                                    <button type="button" class="btn btn-ghost btn-xs btn-circle" @click="clearStation">
                                        <X class="h-3 w-3" />
                                    </button>
                                </div>
                            </div>
                            ...
                            <div v-else>
                                ...
                                <div
                                    v-if="
                                        showStationDropdown && (stationResults.length > 0 || stationQuery.length >= 2)
                                    "
