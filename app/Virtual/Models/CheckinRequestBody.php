 ...
 *     @OA\Property(property="userId", type="array", @OA\Items(type="integer", example="1"), example="[1, 2]", nullable=true, description="If set, the checkin will be created for all given users. If not set, the checkin will be created for the authenticated user. Please note, that you have to add the authenticated userId here too, if you want to checkin the authenticated User AND other users."),
 * )
 */
