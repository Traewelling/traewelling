...
class OperatorService
{
    ...
    public function parseTransitousOperator(?string $agencyId, ?string $agencyName): ?HafasOperator {
        ...
        try {
            ...
            $operatorMappings = self::loadOperatorMappings();
            ...
            $foundMapping = self::findMapping($operatorMappings, $agencyId, $agencyName);
            ...
            if ($foundMapping) {
                ...
                $officialNames = self::loadOperatorOfficialNames();
     ...
     */
    private static function loadOperatorMappings(): array {
     ...
     */
    private static function findMapping(array $operatorMappings, string $agencyId, string $agencyName): ?array {
    ...
    public static function refreshFiles(): void {
        self::refreshFile('mapping', self::MAPPING_FILE_PATH);
        self::refreshFile('operators', self::OPERATOR_FILE_PATH);
    }

    private static function refreshFile(string $remoteFilename, string $localFilename): void {
