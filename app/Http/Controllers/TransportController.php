...
class TransportController extends Controller
{
     ...
     * @return String
     */
    static function dateMySQLEscape(String $in): String {
    ...
    public function trainCheckin(Request $request) {
        ...
        $trainCheckin->departure = self::dateMySQLEscape($stopovers[$offset1]['departure']);
        $trainCheckin->arrival = self::dateMySQLEscape($stopovers[$offset2]['arrival']);
