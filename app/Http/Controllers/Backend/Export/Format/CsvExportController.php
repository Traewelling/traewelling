        ...
        return static function() use ($data) {
            ...
            foreach ($data as $status) {
                $row = [
                    ...
                    ($status->trainCheckin->real_departure ?? $status->trainCheckin->origin_stopover->departure)?->toIso8601String(),
                    ...
                    ($status->trainCheckin->real_arrival ?? $status->trainCheckin->destination_stopover->arrival)?->toIso8601String(),
