        ...
        return static function() use ($data) {
            ...
            foreach ($data as $status) {
                $row = [
                    ...
                    $status->trainCheckin->originStopover->departure_planned?->toIso8601String(),
                    ($status->trainCheckin->manual_departure ?? $status->trainCheckin->originStopover->departure)?->toIso8601String(),
                    ...
                    $status->trainCheckin->destinationStopover->arrival_planned?->toIso8601String(),
                    ($status->trainCheckin->manual_arrival ?? $status->trainCheckin->destinationStopover->arrival)?->toIso8601String(),
