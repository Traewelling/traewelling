...
class StatusController extends Controller
{
    public static function getStatus($id) {
        return Status::where('id', $id)->with('trainCheckin', 'trainCheckin.getOrigin', 'trainCheckin.getHafasTrip', 'trainCheckin.getDestination')->firstOrFail(); //I'm not sure if that's the correct way to do. Will need to revisit this during API-Development.
    }
