...
class StatusController extends Controller
{
    ...
    public static function ExportStatuses($startDate,
        ...
        $endInclLastOfMonth = (new \DateTime($endDate))->add(new \DateInterval("P1D"))
                                                       ->format("Y-m-d");
        ...
        foreach ($trainCheckins as $t) {
            ...
            $export   = array_merge($export, [[
                                                  ...
                                                  $t->trainCheckin->Origin->latitude . ', ' . $t->trainCheckin
                                                                                                ->Origin->longitude,
                                                  $t->trainCheckin->departure,
                                                  $t->trainCheckin->Destination->name,
                                                  $t->trainCheckin->Destination->latitude . ', ' . $t->trainCheckin
                                                                                                     ->Destination
                                                                                                     ->longitude,
