...
namespace Revolution\Mastodon\Facades {
    ...
    class Mastodon {
         ...
         * @static 
         */
        public static function call($method, $api, $options = [])
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->call($method, $api, $options);
        }
         ...
         * @static 
         */
        public static function get($api, $query = [])
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
         ...
         * @static 
         */
        public static function apiVersion($api_version)
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->apiVersion($api_version);
        }
         ...
         * @static 
         */
        public static function apiBase($api_base)
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->apiBase($api_base);
        }
         ...
         * @static 
         */
        public static function createApp($client_name, $redirect_uris, $scopes, $website = '')
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->createApp($client_name, $redirect_uris, $scopes, $website);
        }
         ...
         * @static 
         */
        public static function statuses($account_id, $limit = 40, $since_id = null)
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->statuses($account_id, $limit, $since_id);
        }
         ...
         * @static 
         */
        public static function createStatus($status, $options = null)
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->createStatus($status, $options);
        }
        ...
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->status($status_id);
        }
         ...
         * @static 
         */
        public static function streaming($url, $callback)
        {
            /** @var \Revolution\Mastodon\MastodonClient $instance */
            return $instance->streaming($url, $callback);
        }
        ...
        public static function macro($name, $macro)
        {
            \Revolution\Mastodon\MastodonClient::macro($name, $macro);
        }
        ...
        public static function mixin($mixin, $replace = true)
        {
            \Revolution\Mastodon\MastodonClient::mixin($mixin, $replace);
        }
        ...
        public static function hasMacro($name)
        {
            return \Revolution\Mastodon\MastodonClient::hasMacro($name);
        }
        ...
        public static function flushMacros()
        {
            \Revolution\Mastodon\MastodonClient::flushMacros();
        }
...
namespace Spatie\Prometheus\Facades {
    ...
    class Prometheus {
         ...
         * @static 
         */
        public static function addGauge($label, $value = null, $name = null, $namespace = null, $helpText = null)
        {
            /** @var \Spatie\Prometheus\Prometheus $instance */
            return $instance->addGauge($label, $value, $name, $namespace, $helpText);
        }
         ...
         * @static 
         */
        public static function addCounter($label, $initialValue = null, $name = null, $namespace = null, $helpText = null)
        {
            /** @var \Spatie\Prometheus\Prometheus $instance */
            return $instance->addCounter($label, $initialValue, $name, $namespace, $helpText);
        }
         ...
         * @static 
         */
        public static function registerCollector($collector)
        {
            /** @var \Spatie\Prometheus\Prometheus $instance */
            return $instance->registerCollector($collector);
        }
         ...
         * @static 
         */
        public static function registerCollectorClasses($collectors)
        {
            /** @var \Spatie\Prometheus\Prometheus $instance */
            return $instance->registerCollectorClasses($collectors);
        }
         ...
         * @static 
         */
        public static function renderCollectors($urlName = 'default')
        {
            /** @var \Spatie\Prometheus\Prometheus $instance */
            return $instance->renderCollectors($urlName);
        }
...
namespace Illuminate\Routing {
    ...
    class Router {
         ...
         * 
         *
         * @see \Spatie\PersonalDataExport\PersonalDataExportServiceProvider::packageBooted()
         * @param string $url
         * @static 
         */
...
namespace  {
    ...
    class Mastodon extends \Revolution\Mastodon\Facades\Mastodon {}
    ...
    class Prometheus extends \Spatie\Prometheus\Facades\Prometheus {}
}
